...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=DM+Mono:ital,wght@0,300;0,400;0,500;1,300&family=Fraunces:ital,opsz,wght@0,9..144,300;0,9..144,400;1,9..144,300&display=swap"
      rel="stylesheet"
    />
    <style>
      /* ── Reset & base ─────────────────────────────────────────── */
  ...
  <body>
    <div class="shell">
      ...
      <header>
        ...
        <p class="header-sub">
          ...
          <a
            href="https://linen-pewter-aa7.notion.site/378262e1a920801a9d3ee6f616bcd17b?v=378262e1a92080d2a7c4000c6c4d5e7a&source=copy_link"
            target="_blank"
            id="notion-workspace-link"
            >public workspace ↗</a
          >
        </p>
      </header>
      ...
      <div class="input-area">
        ...
        <div class="input-meta">
          <span class="rate-counter" id="rate-counter"
            >50 messages remaining today</span
          >
    ...
    <script>
      ...
      function addMessage(role, text, notionUrl) {
        ...
        label.textContent =
          role === "user" ? "You" : role === "assistant" ? "Claude" : "Error";
